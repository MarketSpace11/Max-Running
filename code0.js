...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9904684);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9905588);
}
}
if (isConditionTrue_0) {
...
}{gdjs.evtTools.sound.playMusic(runtimeScene, "chiptune-grooving-142242.mp3", true, 40, 1);
}}
